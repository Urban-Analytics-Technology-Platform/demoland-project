...
Once the baseline is created, **scenarios** can be built, for instance, as effects of targeted intervention on land use and (ultimately) through AI methods via optimisation algorithms.
