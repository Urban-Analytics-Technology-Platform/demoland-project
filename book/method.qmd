...
> Sum of the areas of green space sites available within 15 minutes
...
3. get sites' area
4. run ttm (15min by walking and other means) and generate for each origin amlist of accessible parks
5. generate metric per each OA as _Sum[park size]_
