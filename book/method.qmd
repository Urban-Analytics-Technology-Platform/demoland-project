...
We have two different types of indicators: while air quality and house prices are measurements of "actual data", accessibilities are estimated and generated in a deterministic way, so they cannot be directly modelled/predicted using some explanatory variables.
