...
3. get sites' area
4. run ttm (15min by walking and other means) and generate for each origin a list of accessible sites
5. generate metric per each OA as _Sum [site size]_
...
Time table for public transport is available in England in ... _quote UK2GTFS_ <br/>
We use GTFS data because more used, also for feeding it into the accessibility calculation package
