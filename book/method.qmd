...
Each option is then included as part of the grid search aimed at the selection of the best model parameters and the best definition of the spatial lag in relation to the model performance metrics (*R*<sup>2</sup>, MSE, ME).
