...
Everything is on [accessib.ipynb](./../python/accessib.ipynb)
...
- [ ] time travel matrix   --> more editable??
     - [X] find GTFS data
     - [X] download OSM data
     - [ ] build ~~graph.obj?~~ network
- [X] supply data (opportunities / land use / ...)
- [ ] calculating accessibility to jobs
- [ ] run also for green spaces, as in "minimum travel time to reach n destinations"

Note that the accessibility thing is not supported in the `r5py` (see [here](https://r5py.readthedocs.io/en/stable/notebooks/basic-usage.html#introduction))
