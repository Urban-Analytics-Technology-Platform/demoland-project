...
January starts basically as a contination of work started in December.

_Warming up_<br/>
Image created in Qgis showing median house prices (Mar 2022) and green spaces in Tyne and Wear county (case study):
![](https://github.com/ciupava/LandUseDemonstrator/blob/main/images/tynewear_houseprices2022_greenspace_lsoa.png?raw=true)
Note:<br/>houseprices [data](#house-prices-indicator) are associated to the LSOA boundaries shp via the python code in [`data_prep.ipynb`](./../python/data_prep.ipynb)
<br/>green spaces are from the OS open data base [see description here](#)
