...
![](images/tynewear_lads_msoas.png?raw=true)*The 5 LADs in Tine and Wear (labelled by `LAD20NM` and `LAD20CD`), highlighted in gray the major urban areas, bordered in blue the 145 MSOAs*

and more trials here,

it's a long learing process
...
![](images/WHO_method_for_UGS.png)*another trial with already uploaded image*
