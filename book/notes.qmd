...
![](https://github.com/ciupava/LandUseDemonstrator/blob/main/images/tynewear_lads_msoas.png)*The 5 LADs in Tine and Wear (labelled by `LAD20NM` and `LAD20CD`), highlighted in gray the major urban areas, bordered in blue the 145 MSOAs*
