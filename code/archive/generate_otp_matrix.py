...
otp = OtpsEntryPoint.fromArgs(["--graphs", ".", "--router", "tynewear"])
...
req.setDateTime(
    2023, 1, 19, 8, 00, 00
)  # set departure time https://github.com/opentripplanner/OpenTripPlanner/blob/63d4aa9f128bb7cbd987211e2f41b7c1f560ce21/src/main/java/org/opentripplanner/scripting/api/OtpsRoutingRequest.java#L37
req.setMaxTimeSec(
    7200
)  # set a limit to maximum travel time (seconds) 7200 sec = 2 hours
...
origs = otp.loadCSVPopulation(
    "./graphs/tynewear/tynewear_lsoas_centroids.csv", "Y", "X"
)
dests = otp.loadCSVPopulation(
    "./graphs/tynewear/tynewear_lsoas_centroids.csv", "Y", "X"
)
