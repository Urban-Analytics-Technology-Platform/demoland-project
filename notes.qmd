...
**Note:** first trials in R, as I am more confident with the language, and trying to reproduce the code form carbun calculator for [prep_travel_to_work.R](https://github.com/creds2/CarbonCalculator/blob/master/R/prep_travel_to_work.R),
...
$[\textit{mobility based emissions}] = w_1[trips] \star w_2[distance] \star w_3[\textit{CO}_2 \textit{ emissions factor per mode of transport}]$
