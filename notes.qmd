...
- _1.c_. Green space accessibility
     ...
     <blockquote>
     European Urban Atlas Class 1.4.1 (vector data code 14100): **Green Urban Areas** (European Commission, 2011)<br/>
    ...
    - <mark>CHECKING UK SOURCES</mark><br/>
    data.gov, natural england, ons<br/>
    Ordnance Survey (Open greenspace map)[https://osdatahub.os.uk/downloads/open/OpenGreenspace] *open data* <br/>
    Advantages:
        • more accurate<br/>
