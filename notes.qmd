...
$$I_{i}(l) = w_1^il_{1} \star  w_2^1l_{2} \dots \star w_k^1l_{k}$$

Different indicators can depend from same landuse variables, and per each indicator scenarios can be expressed by acting on the paramters $w_{j}$.

As an example, using the definition above the indicator of Mobility based emissions (a.) could be expressed as:
