...
Some useful and valuable datasets on *accessibility* by several means of transport was (apparently?) available from DFT until 2012.<br/>
...
*Errata corrige* data at LSOA level is also available in gov.uk [in xls format](https://www.gov.uk/government/statistical-data-sets/acs05-travel-time-destination-and-origin-indicators-to-key-sites-and-services-by-lower-super-output-area-lsoa)
...
*screenshot of the available tables from gov.uk*
