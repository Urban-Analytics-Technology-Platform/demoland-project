...
does not appear in the new tables, though, we have the total population (`Empl_pop`) AND the percentage of population per each mode of transport + time, for example:<br/>
