...
![](od_tynewear_1trial.png)
*Origin Destination flows of individuals for commuting to work (2011 UK Census data), the Metropolitan County of Tyne and Wear*
...
As an example, using the definition above the indicator Mobility based emissions (a.) could be expressed <mark>per mode of transport</mark> and per each MSOA as:
...
1. ~~(aggregated at LAD level) UK GHG emissions national statistics, estimates per Local Authority [Data for 2005 - 2020](https://www.gov.uk/government/statistics/uk-local-authority-and-regional-greenhouse-gas-emissions-national-statistics-2005-to-2020)~~$\rightarrow$ this datum is a sum of emissions from 2005-2020, useful??

2. we can get from gov.uk CO<sub>2</sub>e (carbon dioxide equivalent) emissions factors for several occupations and travel modes, including transport, freight, etc [link](https://www.gov.uk/government/collections/government-conversion-factors-for-company-reporting);\\
...
3. OD flows from UK census ... **only to work and home**? *~~check source~~* $\rightarrow$ YES $\Downarrow$
