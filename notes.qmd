...
3. LUR potential predictor variables extraction ... relevant for us? (limited number of variables)

4. LUR output is raster VS vectorial

5. not clear how the _spatial_ connotation enter the model, just because we use data defined at (some) geographic level?
