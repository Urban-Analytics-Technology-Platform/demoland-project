...
- <mark>**UK SOURCES**</mark><br/>
    ...
    - **AHAH [Access to Healthy Assets & Hazards](https://data.cdrc.ac.uk/dataset/access-healthy-assets-hazards-ahah)** (Dani suggested) 
        ...
        • the current version seems to use NDVI for greenspace (from Sentinel)
        <figure>
            <img src="images/ahah_why.png"/ width="650">
            <figcaption>Screenshot from the `metadata` file</figcaption>
        </figure>
        <!-- ![screenshot from the `metadata` file](images/ahah_why.png) -->

        though the latest pubblication claims to use OSM data:
        <blockquote>
