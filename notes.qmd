...
We are searching for data to be used as variables (land use features) to predict 4 indicators (see Intro [here ](intro.qmd#indicators-building)) AND for the indicators as well:
...
**Predictive variables:** *number of access points, areal extention of greenspaces, distance from greenspace*
